...
Inheritance mode: **batch** (inherit_gate_p=0.95, inherit_min_support=2).
...
Environment: Python 3.11.6, numpy 2.2.6, 25 seeds/scenario, wallclock 107.52s.
...
| CIF mean latency/cycle (ms) | 0.284 +/- 0.037 | - |
...
| CIF mean latency/cycle (ms) | 0.525 +/- 0.024 | - |
| Evidence chain verified | True | n/a |
...
| CIF mean latency/cycle (ms) | 0.256 +/- 0.038 | - |
| Evidence chain verified | True | n/a |
...
| CIF mean latency/cycle (ms) | 4.67 +/- 0.33 | - |
| Evidence chain verified | True | n/a |
...
| CIF mean latency/cycle (ms) | 0.267 +/- 0.015 | - |
| Evidence chain verified | True | n/a |
...
| CIF mean latency/cycle (ms) | 3.5 +/- 0.29 | - |
| Evidence chain verified | True | n/a |
